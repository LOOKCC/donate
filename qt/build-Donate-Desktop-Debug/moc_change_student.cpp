...
#include "../Donate/change_student.h"
...
const QMetaObject change_student::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_change_student.data,
      qt_meta_data_change_student,  qt_static_metacall, nullptr, nullptr}
};
...
void *change_student::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_change_student.stringdata0))
        return static_cast<void*>(const_cast< change_student*>(this));
